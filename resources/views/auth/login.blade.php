...
@section('content')
    ...
    <div class="block mx-auto my-12 p-8 bg-white w-1/3 border border-gray-200 rounded-lg shadow-lg">
        <h1 class="text-3xl text-center font-bold">Inicio de Sesíon</h1>
        <form class="mt-4" method="POST" action="">
            ...
            <button type="submit" class="rounded-md bg-blue-800 w-full text-lg text-white font-semibold p-2 my-3 hover:bg-blue-800">Entrar</button>
        </form>
    </div>
@endsection
