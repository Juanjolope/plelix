...
@section('content')
    ...
    <div class="block mx-auto my-12 p-8 bg-white w-1/3 border border-gray-200 rounded-lg shadow-lg">
        ...
        <form class="mt-4" method="POST" action="">
            ...
            <input type="password" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Confirme contraseña" id="password_confirmation" name="password_confirmation">

            <button type="submit" class="rounded-md bg-blue-800 w-full text-lg text-white font-semibold p-2 my-3 hover:bg-blue-800">Enviar</button>
        </form>
    </div>
@endsection
